        ...
        <footer className="footer is-dark">
            <div className="container">
                <div className="columns">
                    ...
                    <div className="column">
                        <h2>Fale Consoco</h2>
                        <a href="http://web.whatsapp.com/send?1=pt_BR&amp;phone=5511952185072">whatts : 11 9 5218-5072</a><br />
                            telefone: 11 2952-6221<br />
                            luana@datacyber.com.br
                    </div>
                    <div className="column">
                        <h2>Suporte</h2>
                        <a href="http://web.whatsapp.com/send?1=pt_BR&amp;phone=5511947009576">whatts : 11 9 4700-9576</a>
